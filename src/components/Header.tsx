                ...
                <div className="flex justify-between items-center h-16">
                    ...
                    >
                        <Image
                            width={128}
                            height={48}
                            src="/logo.png" alt="ProMeets" className="h-10" />
                    </Link>
                    ...
                    <div className="flex items-center space-x-6">
                        ...
                        <div className="hidden lg:flex items-center space-x-4">
                            ...
                            <div className="relative ml-2">
                                ...
                                >
                                    <span className="text-xl mr-1">{getFlagEmoji(selectedLanguage)}</span>
                                ...
                                {isLanguageOpen && (
                                    <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-xl border border-gray-200 py-2 z-10">
                                        {languages.map((lang) => (
                                            <button
                                                key={lang.code}
                                                className={`flex cursor-pointer items-center w-full px-4 py-2 text-sm hover:bg-gray-50 transition-colors duration-150 ${selectedLanguage === `${lang.flag} ${lang.name}` ? 'text-purple-600 bg-purple-50' : 'text-gray-700'
                                                    }`}
                                                onClick={() => {
                        ...
                        >
                            <div className="space-y-2 pl-4 pt-2">
                                {languages.map((lang) => (
                                    <button
                                        key={lang.code}
                                        className={`flex cursor-pointer items-center w-full px-3 py-2 text-sm rounded-md text-left transition-colors duration-150 ${selectedLanguage === `${lang.flag} ${lang.name}`
